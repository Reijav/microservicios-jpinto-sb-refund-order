package com.jpinto.refundquery.listener.transaction.cancel;
...
public class CancelTransactionListener {
    ...
    @KafkaListener(topics = "refund-order.transaction-cancel.v1", groupId = "refund-order.transaction-cancel.v1.group")
